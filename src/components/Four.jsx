            ...
            <section className='py-4 container'>
                <div className='row'>
                    ...
                    {slice.map((item, index) => {
                        ...
                        return (
                            <div className='col-md-4 col-lg-3 col-xs-2 col-sm-2' key={index + 30}>
                                ...
                                <span className='click'>
                                    ...
                                    <div className="overtake">
                                        ...
                                        <i className="bi bi-heart icon f" style={{marginTop : "8px"}}></i>
                                        </OverlayTrigger>

                                        <OverlayTrigger placement="left" overlay={<Tooltip id="tooltip" >Quick View</Tooltip>}>
                                        <i className="bi bi-eye icon f" style={{marginTop : "55px"}}></i>
                                        </OverlayTrigger>

                                        <OverlayTrigger placement="left" overlay={<Tooltip id="tooltip" >Compare</Tooltip>}>
                                        <i className="bi bi-arrow-left-right icon f" style={{marginTop : "100px"}}></i>
                                        </OverlayTrigger>
