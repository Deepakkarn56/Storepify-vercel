            ...
            <section className='py-4 container'>
                <div className='row'>
                    ...
                    {slice.map((item, index) => {
                        ...
                        return (
                            <div className='col-md-4 col-lg-4 col-xs-2 col-sm-2' key={index + 10}>
                                ...
                                <span className='click'>
                                    ...
                                    <div className="overtake">
                                        ...
                                        <i className="bi bi-heart icon t" style={{marginTop : "10px"}}></i>
                                        </OverlayTrigger>

                                        <OverlayTrigger placement="left" overlay={<Tooltip id="tooltip" >Quick View</Tooltip>}>
                                        <i className="bi bi-eye icon t" style={{marginTop : "55px"}}></i>
                                        </OverlayTrigger>

                                        <OverlayTrigger placement="left" overlay={<Tooltip id="tooltip" >Compare</Tooltip>}>
                                        <i className="bi bi-arrow-left-right icon t" style={{marginTop : "100px"}}></i>
                                        </OverlayTrigger>
...
// const [colu, setColu] = useState(4);

{/* <div className="row">
                    <div className={`col-lg-${colu} col-md-${colu} col-sm-${colu} col-xs-${colu}`}>
                        <img src="https://cdn.shopify.com/s/files/1/0624/8638/0738/products/8246588251_2_2_8_c6439845-0e1f-4115-98f0-1a3d267c6178.png?crop=center&height=1200&v=1668409823&width=900" width="100%" />
